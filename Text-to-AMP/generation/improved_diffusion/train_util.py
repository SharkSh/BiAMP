...
class TrainLoop:
    def __init__(
        ...
        *,
        ...
        self.eval_class_weight = eval_class_weight
        self.batch_size = batch_size
        self.microbatch = microbatch if microbatch > 0 else 2 * batch_size
        self.lr = lr
        self.ema_rate = (
            [ema_rate]
    ...
    def _anneal_lr(self):
        ...
        lr_min = 0.000001  
        lr = lr_min + 0.5 * (self.lr - lr_min) * (1 + math.cos(frac_done * math.pi))
